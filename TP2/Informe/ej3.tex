...
\newpage
 ...
 \end{figure}
	...
	Si tenemos esta otra distribuci\'on con costo de refiner\'ia igual a 6:
...
\textcolor{red}{Poner aca lo del script. ``Le puse que tome la cant de pozos y que arme grafos con todas las conexiones posibles de peso random entre 0 y el doble de costo de refiner\'ia''}
\textcolor{blue}{listo?}
