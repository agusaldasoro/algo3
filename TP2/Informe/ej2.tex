...
Al proceder bajo este m\'etodo fue posible efectuar casos de prueba de tama\~no grande. Sin embargo, debido a la dimensi\'on de los casos de tests, hay ciertos aspectos de la soluci\'on del problema que no podemos determinar por nuestra cuenta para contrastar con la soluci\'on propuesta por el algoritmo:
...
De este modo, al ejecutar nuestro algoritmo bajo las instancias aleatorias generadas, obtenemos soluciones para las cuales no podemos contrastar con otros valores para mostrar su correctitud. \textcolor{red}{Nos importa esto? solo queriamos medir tiempos...}\\
...
Las paredes, no son un obstaculo, dado que podrían terminar siendo un pasaje, pero la probabilidad de que eso ocurra es muy baja.\textcolor{red}{hasta aca, no se entiende mucho}
...
\textcolor{red}{[}Estos rangos aleatorios también se obtuvieron experimentando, hasta lograr valores que ocasionaran bajas pero que no impidieran a los soldados llegar al búnker en la mayoría de los casos.\textcolor{red}{]?} Dichos experimentos exceden el interés de esta sección y no serán discutidos.\\
...
Como se puede apreciar, al no haber zombies, no existe ningun camino en el cual mueran soldados, por lo que los tiempos se incrementan acorde a la dimension de la ciudad, y al ser cuadradas, crece \textcolor{red}{polinomialmente ?}.
...
\textcolor{red}{Tal como era esperado, en este grafico se puede apreciar que ... bla bla bla}
