...
Primero vamos a mencionar que este problema cumple con el principio de optimalidad, es decir que para cada subsecuencia de la soluci\'on \'optima, vale que es \'optima si se acotase el problema a esas instancias. Esto se puede ver en la tabla de anterior.
