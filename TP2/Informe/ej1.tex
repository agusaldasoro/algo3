...
Dada una traves\'ia con 3 etapas (A, B y C), para las cu\'ales se cuenta con 1 uso de la moto ($k_m$ = 1) y 2 usos del buggy ($k_b$ = 2). Las diferentes etapas est\'an caracterizadas de la siguiente manera:\\
