...
Reemplazando en la ecuaci\'on, \emph{T(n)=2T(n/2)+O(n)} vemos que es la misma ecuaci\'on de recurrencia que el algortimo de MergeSort, que por Teorema Maestro se deduce tiene complejidad $O(n.log(n))$, como pretend\'iamos.
