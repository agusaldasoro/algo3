...
\textcolor{blue}{no se, se puede dejar como apendice esto no? directamente lo imprimimos del sublime, toda la paja pasar todos los algoritmos a latex, con el main y las funciones extras y bla bla bla}\textcolor{red}{Pero hay una seccion que se llama codigo fuente.... algo hay que poner ahi. Y ademas, el sublime no imprime con colores. Y ademas, tiene que quedar en el pdf!}
